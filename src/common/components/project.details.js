              ...
              >
                <Dialog.Panel className="mt-12 lg:mt-0 md:min-w-[50%] md:max-w-[50%] min-h-screen bg-[#242430] transform overflow-hidden text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    ...
                    style={{
                      backgroundImage: `url(${
                        props.project.projectCoverImage.length > 1
                          ? props.project.projectCoverImage
                          : genProjectCover
                      })`,
                    }}
                  >
                    <button
                      ...
                      className="text-black z-10 self-right float-right"
                    >
                      <svg
                    ...
                    <div className="p-8 bg-[#242430]">
                      <div className="flex flex-col-reverse md:flex-row md:justify-between">
                        <div>
                          ...
                          <p className="text-sm text-white rounded-xl px-2 w-max bg-blue-800 mt-1">
                        ...
                        <div className="flex mb-4 justify-between md:mb-0 md:justify-center">
                          {props.project.projectViewLink ? (
                            <a
                              ...
                              target={"_blank"}
                              className="mr-3 text-white text-sm flex flex-row hover:shadow-amber-500 hover:shadow-md bg-amber-400 px-2 py-[7px] rounded-xl h-max"
                            >
                          ...
                          {props.project.projectGithubLink ? (
                            <a
                              ...
                              target={"_blank"}
                              className="text-white bg-black px-2 py-1 rounded-xl hover:shadow-amber-500 hover:shadow-md h-max"
                            >
                      ...
                      <div className="flex flex-col mt-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 text-white">
                          <h3>
                            Created By:{" "}
                            <span className="text-gray-400">iamdveloper</span>
                          </h3>
                          <h3>
                            Client:{" "}
                        ...
                        <div className="grid grid-cols-2 text-white">
                          ...
                          <h3>
                            End:{" "}
                            <span className="text-gray-400">
                              {formatProjectDate(props.project.projectEndDate)}
                            </span>
                          </h3>
                        </div>
                      </div>
